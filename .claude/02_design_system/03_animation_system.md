...
- [1. アニメーション方針](#1-アニメーション方針)
  - [1.1 基本方針](#11-基本方針)
  - [1.2 使用ケース](#12-使用ケース)
- [2. アニメーション時間とイージング](#2-アニメーション時間とイージング)
  - [2.1 基本タイミング](#21-基本タイミング)
  - [2.2 アニメーションタイプ別設定](#22-アニメーションタイプ別設定)
- [3. Alpine.jsトランジション](#3-alpinejs-トランジション)
  - [3.1 フラッシュメッセージアニメーション](#31-フラッシュメッセージアニメーション)
  - [3.2 モーダルアニメーション](#32-モーダルアニメーション)
  - [3.3 ドロップダウンアニメーション](#33-ドロップダウンアニメーション)
- [4. Livewireアニメーション](#4-livewire-アニメーション)
  - [4.1 ローディングアニメーション](#41-ローディングアニメーション)
  - [4.2 スケルトンローディング](#42-スケルトンローディング)
  - [4.3 スケルトンスタイル](#43-スケルトンスタイル)
- [5. フィードバックアニメーション](#5-フィードバックアニメーション)
  - [5.1 ボタンアニメーション](#51-ボタンアニメーション)
  - [5.2 カードホバー](#52-カードホバー)
  - [5.3 フォームフィールドアニメーション](#53-フォームフィールドアニメーション)
- [6. プログレスアニメーション](#6-プログレスアニメーション)
  - [6.1 注文進行状況](#61-注文進行状況)
  - [6.2 プログレスバー](#62-プログレスバー)
- [7. アクセシビリティ考慮](#7-アクセシビリティ考慮)
  - [7.1 モーション減少設定](#71-モーション減少設定)
  - [7.2 フォーカス表示](#72-フォーカス表示)
- [8. パフォーマンス最適化](#8-パフォーマンス最適化)
  - [8.1 CSSアニメーションの最適化](#81-cssアニメーションの最適化)
  - [8.2 JavaScriptでの最適化](#82-javascript-での最適化)
- [9. 実装ガイドライン](#9-実装ガイドライン)
  - [9.1 アニメーションの選択基準](#91-アニメーションの選択基準)
  - [9.2 ベストプラクティス](#92-ベストプラクティス)
  - [9.3 テスト方法](#93-テスト方法)
